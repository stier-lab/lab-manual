...
**Ocean Recoveries Lab (Stier Lab) Manual**
...
Connect to LifeSci[BuildingName] for computers and LifeSciGadget for phones. New devices require an LSCG appointment. Email help@lifesci.ucsb.edu (EEMB IT) or visit [lscg.ucsb.edu](https://www.lscg.ucsb.edu/) to submit a request. WiFi can be spotty in Noble, so many people use ethernet. Use your ADS username (usually your last name), not your UCNetID.
...
Most lab purchases go through [Gateway](https://gateway.procurement.ucsb.edu/), UCSB's online ordering system. The typical process:
...
- **MSI-administered grants:** Create a [Concur](https://www.concursolutions.com/) expense report (log in with your UCSB NetID) and add Melia Cutcher as an expense delegate.
...
**Storeroom (Gateway/FedEx/UPS):**
Biological Sciences, Bldg. 569 Rm. 1101
...
# Mentoring and Advising Structure
...
4. **Clarity prevents conflict.** Ambiguity about expectations is the root cause of most authorship disputes ([Brown University Guidelines](https://division-research.brown.edu/research-cycle/conduct-research/ethics-research/guidelines-authorship-scholarly-or-scientific)). This section eliminates ambiguity by specifying timelines, milestones, and consequences in advance.

This approach aligns with the [ICMJE principle](https://www.icmje.org/recommendations/browse/roles-and-responsibilities/defining-the-role-of-authors-and-contributors.html) that everyone who meets the first authorship criterion must be given the opportunity to fulfill the remaining criteria — but that opportunity is not open-ended. It is also consistent with the [ESA Code of Ethics](https://esa.org/about/code-of-ethics/), which holds that researchers should "claim authorship of a paper only if they have made a substantial contribution," and the [SCB Code of Ethics](https://conbio.org/about-scb/who-we-are/code-of-ethics/), which requires that authors have "contributed substantially" and "approve of the published version." See the Authorship Policy section for more on our general authorship philosophy.
...
- **Stage C — Data collected, analysis incomplete.** Raw data exist but substantial analytical work remains. This is realistically a handoff. You receive co-authorship and [CRediT](https://credit.niso.org/) credit for data collection, but first authorship defaults to whoever completes the analysis and writes the paper — unless you commit to a Stage B timeline for the analytical work at the Exit Plan Meeting.
...
2. **Authorship agreements.** For each project, confirm the author list, author order, and each person's remaining responsibilities using [CRediT contributor roles](https://credit.niso.org/) (Brand et al. 2015, *Learned Publishing* 28:151–155).
...
The Exit Plan is signed by both of us and kept in the lab's shared drive. This is consistent with [UCSB Graduate Division guidance](https://www.graddiv.ucsb.edu/responsibilities-mentors-student) that students "inform the mentor immediately if they are unable to complete a project."

### Data and Code Requirements

Before departure, you must ensure:

- All datasets and metadata are archived in the lab's shared repository (consistent with the [UC Research Data Policy](https://www.ucop.edu/research-policy-analysis-coordination/policies-guidance/research-data/research-data-policy-faqs.html), which vests data ownership in the UC Regents)
...
See the Data Management and Reproducible Science section for full details on formats, backup, and documentation standards. These requirements follow best practices from [Tendler et al. (2023, *eLife* 12:e88853)](https://elifesciences.org/articles/88853), the [Bahlai Lab's Project Completion Checklist](https://github.com/BahlaiLab/Policies/blob/master/Project_completion.md), and the [BES data archiving policy](https://besjournals.onlinelibrary.wiley.com/hub/data_archiving_policy).

## Completion Timelines

The following deadlines apply from the **date of departure** (your last day in the lab). All deadlines can be extended once by mutual written agreement, for a maximum of 3 additional months. The [University of Alberta's authorship guidelines](https://www.ualberta.ca/en/graduate-studies/resources/policies-procedures/graduate-program-manual/section-10-intellectual-property/10-2-guidelines-for-authorship.html) recommend a 1-year default limit for students; this section adopts that standard with intermediate checkpoints.
...
The reasoning here: listing someone as a co-author when they cannot approve the final version or agree to accountability violates [ICMJE criteria](https://www.icmje.org/recommendations/browse/roles-and-responsibilities/defining-the-role-of-authors-and-contributors.html) 3 and 4. The [Carey Lab at Virginia Tech](https://github.com/CareyLabVT/LabDocuments/blob/master/docs/Authorship_Guidelines.md) and the [SCB Code of Ethics](https://conbio.org/about-scb/who-we-are/code-of-ethics/) take the same position.

## What Authorship Reassignment Looks Like

I want to be clear about this because it is the part most likely to cause anxiety. Reassignment is not punishment. It is the recognition that authorship requires ongoing intellectual contribution, not just past effort. The [ICMJE](https://www.icmje.org/recommendations/browse/roles-and-responsibilities/defining-the-role-of-authors-and-contributors.html) is explicit: all four criteria must be met, including drafting or critically revising the work, approving the final version, and agreeing to be accountable.
...
2. **CRediT roles are updated** to accurately reflect who did what. The [BES](https://besjournals.onlinelibrary.wiley.com/hub/editorial-policies) requires Author Contributions statements for all multi-author papers; CRediT roles serve this function.
...
This mirrors the [Lowe-Power Lab approach](https://github.com/lowepowerlab/lab_handbook/blob/master/README.md) and is consistent with the [SCB principle](https://conbio.org/about-scb/who-we-are/code-of-ethics/) that data collectors should be considered for authorship even if they are not writing the paper.
...
2. **Active mentoring during the exit period.** I will check in at agreed intervals and help problem-solve barriers to completion. This implements the [UCSB Graduate Division expectation](https://www.graddiv.ucsb.edu/responsibilities-mentors-student) that faculty provide "timely feedback on research" and "constructive criticism if the student's progress does not meet expectations."
...
As the [Office of Research Integrity](https://ori.hhs.gov/authorship-faculty-student-collaborations) notes, faculty mentors bear significant responsibility for modeling ethical authorship practices. I take that seriously.
...
3. **Third step:** Formal review through UCSB institutional channels:
   - **Graduate students:** The [UCSB Graduate Division](https://www.graddiv.ucsb.edu/responsibilities-mentors-student) can facilitate resolution.
   - **All lab members:** The [UCSB Office of the Ombuds](https://ombuds.ucsb.edu/) provides confidential, impartial, and informal conflict resolution.
   - **Research misconduct concerns:** The [UCSB Office of Research](https://www.research.ucsb.edu/research-integrity/rcr) handles formal allegations.
...
- **Discuss authorship early and revisit it regularly.** [Brown University](https://division-research.brown.edu/research-cycle/conduct-research/ethics-research/guidelines-authorship-scholarly-or-scientific) recommends discussing authorship "as early as practical and frequently during the course of their work." The [University of Oregon](https://research.uoregon.edu/manage/integrity-compliance/responsible-conduct-research/authorship-guidance) recommends revisiting agreements whenever "relative contributions change." See the Authorship Policy section for our approach.
...
- **Data retention.** Federal funding agencies require a minimum 3-year retention period; UC's internal standard for IRB-related records is 10 years ([UCOP Records Retention](https://www.ucop.edu/research-policy-analysis-coordination/policies-guidance/record-retention/index.html)). I ensure data is retained for the most stringent applicable period.
...
- [Ecological Society of America Code of Ethics](https://esa.org/about/code-of-ethics/) (amended May 2021)
- [ESA Professional Ethics Committee](https://esa.org/about/governance/standing-committees/professional-ethics-committee/)
- [Society for Conservation Biology Code of Ethics](https://conbio.org/about-scb/who-we-are/code-of-ethics/)
- [British Ecological Society Editorial Policies](https://besjournals.onlinelibrary.wiley.com/hub/editorial-policies)
- [British Ecological Society Data Archiving Policy](https://besjournals.onlinelibrary.wiley.com/hub/data_archiving_policy)

### National and Professional Standards

- [ICMJE Recommendations on Authorship](https://www.icmje.org/recommendations/browse/roles-and-responsibilities/defining-the-role-of-authors-and-contributors.html)
- [CRediT Contributor Roles Taxonomy](https://credit.niso.org/) — Brand et al. (2015), *Learned Publishing* 28:151–155
- [Office of Research Integrity: Authorship in Faculty-Student Collaborations](https://ori.hhs.gov/authorship-faculty-student-collaborations)

### UC and UCSB Policies

- [UC Research Data Policy FAQs](https://www.ucop.edu/research-policy-analysis-coordination/policies-guidance/research-data/research-data-policy-faqs.html)
- [UCSB Research Data Guidance](https://www.research.ucsb.edu/research-data-guidance)
- [UCSB TIA Forms & Policies (Data Transfer)](https://tia.ucsb.edu/forms-policies/)
- [UCSB Graduate Division: Copyright, Coauthorship, and Reprint Permissions](https://www.graddiv.ucsb.edu/our-services/academic-services/filing/filing-your-thesis-dissertation-or-dma-supporting-document-0)
- [UCSB Graduate Division: Responsibilities for Mentors & Students](https://www.graddiv.ucsb.edu/responsibilities-mentors-student)
- [UCSB Mentoring Best Practices & Guidelines](https://www.graddiv.ucsb.edu/mentoring-guidelines)
- [UCSB Office of Research: Responsible Conduct of Research](https://www.research.ucsb.edu/research-integrity/rcr)
- [UCOP Research Record Retention and Disposition](https://www.ucop.edu/research-policy-analysis-coordination/policies-guidance/record-retention/index.html)

### Other University Policies

- [Brown University: Guidelines on Authorship](https://division-research.brown.edu/research-cycle/conduct-research/ethics-research/guidelines-authorship-scholarly-or-scientific)
- [University of Alberta: Guidelines for Authorship, Section 10.2](https://www.ualberta.ca/en/graduate-studies/resources/policies-procedures/graduate-program-manual/section-10-intellectual-property/10-2-guidelines-for-authorship.html)
- [University of Oregon: Authorship Guidance](https://research.uoregon.edu/manage/integrity-compliance/responsible-conduct-research/authorship-guidance)
- [Harvard Medical School: Data Management Offboarding](https://datamanagement.hms.harvard.edu/about/where-start/data-management-offboarding)
- [Harvard Medical School: Authorship Guidelines](https://hms.harvard.edu/sites/default/files/assets/Sites/Ombuds/files/AUTHORSHIP%20GUIDELINES.pdf)

### Published Lab Policies and Handbooks

- Tendler, B.C., et al. (2023). Research Culture: Why every lab needs a handbook. [*eLife*, 12, e88853](https://elifesciences.org/articles/88853)
- [Carey Lab, Virginia Tech: Authorship Guidelines](https://github.com/CareyLabVT/LabDocuments/blob/master/docs/Authorship_Guidelines.md)
- [Lowe-Power Lab, UC Davis: Lab Handbook](https://github.com/lowepowerlab/lab_handbook/blob/master/README.md)
- [Bahlai Lab, Kent State: Project Completion Checklist](https://github.com/BahlaiLab/Policies/blob/master/Project_completion.md)
- [UCSF Decision Lab: Authorship](https://decisionlab.ucsf.edu/handbook/authorship.html)
...
UCSB runs grad-specific wellness events covering stress reduction, mindfulness, art therapy, and healthy eating. Includes a weekly Drop-In Wellness Center at the Graduate Student Lounge. Details at [wellness.ucsb.edu/graduates](https://wellness.ucsb.edu/graduates).
...
Access [Connexxus](https://bfs.ucsb.edu/travel_entertainment/travel-planning/connexxus) through the BFS website or through the Travel section of Concur. You must be an active UCSB employee. If you book outside Connexxus, you must separately register your trip at [UC Away](https://www.ucop.edu/risk-services-travel/registering.html) to activate travel insurance.
...
- **Travel insurance:** Book through Connexxus (auto-registers) or register manually at [UC Away](https://www.ucop.edu/risk-services-travel/registering.html). This activates UC's global travel insurance, which covers emergency medical evacuation, out-of-country medical expenses, and security extraction.
...
- **EEMB travel:** Andi Jorgensen
- **MSI travel:** Kim Taylor (travel@msi.ucsb.edu)
- **Connexxus and Concur help:** concur@bfs.ucsb.edu
- **Travel training:** [financialtraining.ucsb.edu](https://financialtraining.ucsb.edu/)
- **UC Away registration:** [UC Away](https://www.ucop.edu/risk-services-travel/registering.html)
...
Kristen Labonte is the EEMB subject librarian. Set up your Library account at the front desk. Checkout periods vary by position. You can also schedule a one-on-one research consultation with a librarian through [LibCal](https://libcal.library.ucsb.edu/appointments) — they can help with literature search strategies, navigating citation databases, and locating specialized resources.
...
- **UC Library Search:** Searching through [UC Library Search](https://search.library.ucsb.edu) authenticates you automatically for article PDFs.
...
The [EEMB LibGuide](https://guides.library.ucsb.edu/eemb) is your best starting point for discipline-specific resources. Databases you should know:
...
- Register at [UC Away](https://www.ucop.edu/risk-services-travel/registering.html) for UC travel insurance
...
- UC travel insurance registration ([UC Away](https://www.ucop.edu/risk-services-travel/registering.html))
...
- You'll need a Life Sciences Computing Group (LSCG) appointment for new devices. Visit [lscg.ucsb.edu/help](https://www.lscg.ucsb.edu/) or email help@lscg.ucsb.edu to submit a request
